<div class="sidebar" data-color="orange" data-background-color="white" data-image="{{ asset('material') }}/img/sidebar-1.jpg">
  ...
  <div class="logo">
    <a href="{{ route('home') }}" class="simple-text logo-normal">
      <img class="" src="./logo-hq.png" style="width: 40%;">
    </a>
  </div>
          ...
          <ul class="nav">
            <li class="nav-item{{ $activePage == 'profile' ? ' active' : '' }}">
              <a class="nav-link" href="{{ route('profile.edit') }}">
                ...
                <span class="sidebar-normal">{{ __('Hồ sơ') }} </span>
              </a>
            </li>
            <li class="nav-item{{ $activePage == 'user-management' ? ' active' : '' }}">
              <a class="nav-link" href="{{ route('user.index') }}">
                <span class="sidebar-mini"> * </span>
                <span class="sidebar-normal"> {{ __('Quản lý hồ sơ') }} </span>
              </a>
            </li>
          </ul>
        </div>
        ...
        <div class="collapse show" id="laravelExample1">
          <ul class="nav">
            <li class="nav-item{{ $activePage == 'profile' ? ' active' : '' }}">
              <a class="nav-link" href="{{ route('profile.edit') }}">
                <span class="sidebar-mini"> * </span>
                <span class="sidebar-normal">{{ __('Amazon') }} </span>
              </a>
            </li>
            <li class="nav-item{{ $activePage == 'user-management' ? ' active' : '' }}">
              <a class="nav-link" href="{{ route('user.index') }}">
                <span class="sidebar-mini"> * </span>
                <span class="sidebar-normal"> {{ __('Shopee') }} </span>
              </a>
            </li>
          </ul>
        </div>
